<?php
    ...
    */
	...
	// CoSSMic configuration
	// this section is for configuring the CoSSMic sync process to post data into a cloud emoncms.
	// address of the cloud emoncms
	$cossmic['host'] = 'http://cloud.cossmic.eu/';
