...
<table class="table">
  <tr><td><?php echo _('Add a task'); ?></td><td><a href="<?php echo $path; ?>mas/add.json?json={'EST': '10:00:00','LST': '15:00:00','deviceID': '1', 'execution_type': 'single_run', 'mode' : 'eco'}"><?php echo $path; ?>mas/add.json?json={'EST': '10:00:00','LST': '15:00:00','deviceID': '1', 'execution_type': 'single_run', 'mode' : 'eco'}</a></td></tr>
  ...
  <tr><td><?php echo _('Update a task'); ?></td><td><a href="<?php echo $path; ?>mas/update.json?id=44&json={'status':1, 'AST':'18:00'}"><?php echo $path; ?>mas/update.json?id=44&json={'status':1, 'AST':'18:00'}</a></td></tr>  
