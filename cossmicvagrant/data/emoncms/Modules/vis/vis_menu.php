<?php
	...
	//If the user is an admin he will not get the vis menu (considering all end-systems are supposed to have only one account and this is an admin account from what we have heard)
