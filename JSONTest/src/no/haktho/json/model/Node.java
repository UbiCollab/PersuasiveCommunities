...
public class Node implements Serializable{
	...
	long pv_kwhd_time;
	long pv_kwh_time;
	int grid2storage_kwh_time;
	int grid2storage_power_time;
	int grid2storage_kwhd_time;	
	int grid2household_kwh_time;
	int grid2household_power_time;
	int grid2household_kwhd_time;
	int pv2storage_kwh_time;
	int pv2storage_power_time;
	int pv2storage_kwhd_time;
	int pv2household_kwh_time;
	int pv2household_power_time;
	int pv2household_kwhd_time;
	int pv2grid_kwh_time;
	int pv2grid_power_time;
	int pv2grid_kwhd_time;
	int storage2grid_khw_time;
	int storage2grid_power_time;
	int storage2grid_kwhd_time;
	int storage2household_kwh_time;
	int storage2household_power_time;
	int storage2household_kwhd_time;
...
//	}
	...
	public int getGrid2storage_kwh_time() {
		return grid2storage_kwh_time;
	}

	public void setGrid2storage_kwh_time(int grid2storage_kwh_time) {
		this.grid2storage_kwh_time = grid2storage_kwh_time;
	}

	public int getGrid2storage_power_time() {
		return grid2storage_power_time;
	}

	public void setGrid2storage_power_time(int grid2storage_power_time) {
		this.grid2storage_power_time = grid2storage_power_time;
	}

	public int getGrid2storage_kwhd_time() {
		return grid2storage_kwhd_time;
	}

	public void setGrid2storage_kwhd_time(int grid2storage_kwhd_time) {
		this.grid2storage_kwhd_time = grid2storage_kwhd_time;
	}

	public int getGrid2household_kwh_time() {
		return grid2household_kwh_time;
	}

	public void setGrid2household_kwh_time(int grid2household_kwh_time) {
		this.grid2household_kwh_time = grid2household_kwh_time;
	}

	public int getGrid2household_power_time() {
		return grid2household_power_time;
	}

	public void setGrid2household_power_time(int grid2household_power_time) {
		this.grid2household_power_time = grid2household_power_time;
	}

	public int getGrid2household_kwhd_time() {
		return grid2household_kwhd_time;
	}

	public void setGrid2household_kwhd_time(int grid2household_kwhd_time) {
		this.grid2household_kwhd_time = grid2household_kwhd_time;
	}

	public int getPv2storage_kwh_time() {
		return pv2storage_kwh_time;
	}

	public void setPv2storage_kwh_time(int pv2storage_kwh_time) {
		this.pv2storage_kwh_time = pv2storage_kwh_time;
	}

	public int getPv2storage_power_time() {
		return pv2storage_power_time;
	}

	public void setPv2storage_power_time(int pv2storage_power_time) {
		this.pv2storage_power_time = pv2storage_power_time;
	}

	public int getPv2storage_kwhd_time() {
		return pv2storage_kwhd_time;
	}

	public void setPv2storage_kwhd_time(int pv2storage_kwhd_time) {
		this.pv2storage_kwhd_time = pv2storage_kwhd_time;
	}

	public int getPv2household_kwh_time() {
		return pv2household_kwh_time;
	}

	public void setPv2household_kwh_time(int pv2household_kwh_time) {
		this.pv2household_kwh_time = pv2household_kwh_time;
	}

	public int getPv2household_power_time() {
		return pv2household_power_time;
	}

	public void setPv2household_power_time(int pv2household_power_time) {
		this.pv2household_power_time = pv2household_power_time;
	}

	public int getPv2household_kwhd_time() {
		return pv2household_kwhd_time;
	}

	public void setPv2household_kwhd_time(int pv2household_kwhd_time) {
		this.pv2household_kwhd_time = pv2household_kwhd_time;
	}

	public int getPv2grid_kwh_time() {
		return pv2grid_kwh_time;
	}

	public void setPv2grid_kwh_time(int pv2grid_kwh_time) {
		this.pv2grid_kwh_time = pv2grid_kwh_time;
	}

	public int getPv2grid_power_time() {
		return pv2grid_power_time;
	}

	public void setPv2grid_power_time(int pv2grid_power_time) {
		this.pv2grid_power_time = pv2grid_power_time;
	}

	public int getPv2grid_kwhd_time() {
		return pv2grid_kwhd_time;
	}

	public void setPv2grid_kwhd_time(int pv2grid_kwhd_time) {
		this.pv2grid_kwhd_time = pv2grid_kwhd_time;
	}

	public int getStorage2grid_khw_time() {
		return storage2grid_khw_time;
	}

	public void setStorage2grid_khw_time(int storage2grid_khw_time) {
		this.storage2grid_khw_time = storage2grid_khw_time;
	}

	public int getStorage2grid_power_time() {
		return storage2grid_power_time;
	}

	public void setStorage2grid_power_time(int storage2grid_power_time) {
		this.storage2grid_power_time = storage2grid_power_time;
	}

	public int getStorage2grid_kwhd_time() {
		return storage2grid_kwhd_time;
	}

	public void setStorage2grid_kwhd_time(int storage2grid_kwhd_time) {
		this.storage2grid_kwhd_time = storage2grid_kwhd_time;
	}

	public int getStorage2household_kwh_time() {
		return storage2household_kwh_time;
	}

	public void setStorage2household_kwh_time(int storage2household_kwh_time) {
		this.storage2household_kwh_time = storage2household_kwh_time;
	}

	public int getStorage2household_power_time() {
		return storage2household_power_time;
	}

	public void setStorage2household_power_time(int storage2household_power_time) {
		this.storage2household_power_time = storage2household_power_time;
	}

	public int getStorage2household_kwhd_time() {
		return storage2household_kwhd_time;
	}

	public void setStorage2household_kwhd_time(int storage2household_kwhd_time) {
