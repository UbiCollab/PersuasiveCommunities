...
//			System.out.println(jsonO.toString());
			if(n > -1){
				...
				String testString = "Node:"+subStr;
				if(testString.equals(temp.getName())){
						...
						if(Character.isDigit(c)){
							...
							case "grid2household_power":
								try {
									...
									temp.setGrid2household_power(jsonO.getDouble("value"));
									 ...
									 temp.setGrid2household_power(0);
								}
							...
							case "storage2household_kwh":
								try {
									...
									temp.setStorage2household_kwh(0);
								}
							...
							case "storage2household_power":
								try {
									...
									temp.setStorage2household_power(0);
								}
							...
							case "storage2household_kwhd":
								try {
									...
									temp.setStorage2household_kwhd(0);
								}
